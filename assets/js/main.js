...
for (i = 1; i <= 100; i++) {
    ...
    if ((i % 3 == 0) && (i % 5 == 0)) {
        ...
        listItem = `<li class="square col fb">${frizzBuzzElement}</li>`
    } else if (i % 3 == 0) {
        console.log('frizz');
        listItem = `<li class="square col f">${frizzElement}</li>`
    } else if (i % 5 == 0) {
        console.log('buzz');
        listItem = `<li class="square col b">${buzzElement}</li>`
    } else {
        console.log(i);
        listItem = `<li class="square col numeri">${iElement}</li>`
    }
